...
const copy = {
  en: {
    ...
    gasManualTitle: 'Set up Apps Script (manual)',
    gasManualSteps: 'Steps',
    gasManualScopes: 'Required permissions',
    gasManualCode: 'Code to paste',
    copy: 'Copy',
    copied: 'Copied',
  ...
  'zh-Hant': {
    ...
    gasManualTitle: 'Apps Script 手動設定',
    gasManualSteps: '操作步驟',
    gasManualScopes: '所需權限',
    gasManualCode: '要貼上的程式碼',
    copy: '複製',
    copied: '已複製',
    notifications: '通知',
...
function ManualCodeBlock({
  ...
  return (
    <div className="mt-2">
      ...
      <pre className="mt-1 max-h-56 overflow-auto rounded-lg bg-slate-900 p-3 text-[11px] leading-5 text-slate-100">
        <code>{source}</code>
      </pre>
    </div>
  );
